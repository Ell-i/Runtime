...
clean::
	make -C $(TOP)build -f $(TOP)make/system_libs.mk PLATFORM=$(PLATFORM) VARIANT=$(VARIANT) clean

$(SYSTEM_LIBS):
	make -C $(TOP)build -f $(TOP)make/system_libs.mk PLATFORM=$(PLATFORM) VARIANT=$(VARIANT) all
