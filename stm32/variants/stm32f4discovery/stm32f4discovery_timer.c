...
/*
 * Boot-time definitions for the STM32F4 series MCU timers.
 */
...
DEFINE_TIMER(1, 4,  TIM_INIT_DefaultRecords, TIM_INIT_EnableRecords);
DEFINE_TIMER(1, 5,  TIM_INIT_DefaultRecords, TIM_INIT_EnableRecords);
...
DEFINE_TIMER(2, 8,  TIM_INIT_DefaultRecords, TIM_INIT_EnableRecords);
DEFINE_TIMER(2, 9,  TIM_INIT_DefaultRecords, TIM_INIT_EnableRecords);
DEFINE_TIMER(2, 10,  TIM_INIT_DefaultRecords, TIM_INIT_EnableRecords);
DEFINE_TIMER(2, 11,  TIM_INIT_DefaultRecords, TIM_INIT_EnableRecords);
DEFINE_TIMER(1, 12,  TIM_INIT_DefaultRecords, TIM_INIT_EnableRecords);
DEFINE_TIMER(1, 13,  TIM_INIT_DefaultRecords, TIM_INIT_EnableRecords);
DEFINE_TIMER(1, 14, TIM_INIT_DefaultRecords, TIM_INIT_EnableRecords);
