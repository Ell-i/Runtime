...
/*
 * Boot-time definitions for the STM32F4 series MCU GPIO registers.
 */
...
DEFINE_GPIO_PORT(E, GPIOE_INIT_DefaultRecords, GPIOE_INIT_AltFunctRecords);
