...
//res   |   FR_LEN_CHK  /* 1: Check frame lengths */
    ...
    D16(E_CON2,
        ...
        |   MODLEN_1024       /* 10: 1024-bit exponential modulus and operands */
        |   AESLEN_256        /* 10: 256-bit AES */
        ),

    D16(E_INT_ENA,
        0
        |   INT              /* 1: Enable INT pin */
        |   PKT              /* 1: Interrupt on pending packets */
        | ! DMA              /* 0: Disable DMA interrupt */
        |   LINK             /* 1: Interrupt on link status change */
        |   TX               /* 1: Interrupt on transmit ready */
// XXX  |   E_INT_ENA_WOL      /* 1: Enable WOL pin */
        | ! TX_ABT           /* 0: Disable transmit error interrupts */
        | ! RX_ABT           /* 0: Disable receive error interrupts */
        ),
    D16(E_CON1,
        0
